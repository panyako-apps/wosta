...
const selectedCategory = ref(props.category.parent_id);


const form = useForm({
    name: props.category.name,
    description: ref(props.category.description),
...
function submit() {
    ...
    router.post(route('admin.servicecategory.update', props.category.id),{
        _method: 'put',
        name: form.name,
...
<template>
    ...
    <Modal :show="show" :closeable="true">
        <div class="pt-4 px-6 border-b pb-2">
            <h4 class="uppercase text-blue-600 font-bold">Edit Service Category.</h4>
        </div>
