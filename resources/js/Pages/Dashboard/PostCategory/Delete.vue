...
function deletePostCategory() {
    ...
    router.post(route('admin.postcategory.destroy', props.category.id),
        {
            _method: 'delete'
        }, 
        {
    ...
    <Modal :show="show" :closeable="true">
        ...
        <div v-if="!inProgress" class="p-6">
            <div class="flex gap-4 items-center mb-6">
                    <div v-if="category.image" class="h-24">
                        <img :src="category.image" class="h-full" >
                    </div>
                    <div class="grow">
                        <h3 class="uppercase font-bold text-blue-800">{{ category.name }}</h3>
