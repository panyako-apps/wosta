    ...
    public function run()
    {
        ...
        $services = [
            ...
            [
                ...
                'description' => 'We provide guidance and support to students planning to travel or move to a new country. The goal is to ensure that the students are well-informed and prepared for the transition,  practically and emotionally.
                ...
                Join us for cultural growth opportunities while you’re abroad.',
                'tags' => '',
            ...
            [
                ...
                'description' => 'Career pathway consulting involves working to help you identify your career goals, assess their strengths and weaknesses, and develop a plan to achieve those goals.
                ...
                Overall, we seek a deep understanding of your goals, skills, and strengths, and are committed to providing ongoing support and resources to help you achieve your goals. ',
                'tags' => '',
            ...
            [
                ...
                'description' => 'We will guide and support you on how the correct format for documents such as reports, proposals, and resumes. 
                ...
                We discuss all other documents with you and are here to guide students in presenting the necessary documents in the required format',
            ...
            [
                ...
                'description' => 'We provide guidance and support to students applying to colleges and universities. It helps students identify appropriate universities and programs, create effective application materials, and navigate the admissions process.
                ...
                We do the necessary follow-up and secure admissions in the shortest possible time',
            ...
            [
                ...
                'description' => 'The most integral part of your study-abroad dream plan is preparing for the visa application needed for your course of study. The exact process and requirements can vary depending on the country you\'re applying to and your individual circumstances
                ...
                Overall, We ensure that you are well-prepared to follow all the instructions and requirements. If you have any questions or concerns, don\'t hesitate to reach out. Good luck with your application!',
