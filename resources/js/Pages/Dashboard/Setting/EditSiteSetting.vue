...
function submit() {
    ...
    router.post(route('admin.sitesetting.update', props.sitesetting.id),{
        _method: 'put',
        title: form.title,
...
<template>
    ...
    <Modal :show="show" :closeable="true">
        <div class="pt-4 px-6 border-b pb-2">
            <h4 class="uppercase text-sky-600 font-bold">Edit Site Setting.</h4>
        </div>
