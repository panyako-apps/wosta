...
const inputClasses = 'block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary focus:ring-secondary sm:text-sm'
...
function submit() {
    ...
    router.post(route('admin.service.store'),{
        name: form.name,
...
<template>
    ...
    <Modal :show="show" :closeable="true">
        ...
        <div class="pt-4 px-6 border-b pb-2">
            <h4 class="uppercase text-blue-600 font-bold">Add Service / Service</h4>
        </div>
        ...
        <div v-if="!inProgress" class="p-6">
            <form @submit.prevent="submit">
                ...
                <div class="md:grid grid-cols-2 gap-4 mb-3">
                    <div class="">
                        <InputLabel for="name" value="Service Name / Title" />
                        <TextInput 
                            id="name" 
                            type="text" 
                            :class="inputClasses" 
